...
import { ArrowLeft, Fuel, Plus, FileSpreadsheet, Search, Filter, Calendar as CalendarIcon, ExternalLink } from "lucide-react"
        ...
        <div className="p-8 max-w-7xl mx-auto space-y-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex gap-2 w-full md:w-auto">
                    <Button variant="outline" onClick={exportToExcel} className="flex-1 md:flex-none gap-2">

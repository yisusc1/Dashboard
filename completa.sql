...
CREATE TABLE public.reportes (
  ...
  botiquin_salida boolean DEFAULT false,
  frenos_salida boolean DEFAULT false,
  estado_cauchos_salida text,
  corneta_salida boolean DEFAULT false,
  ...
  botiquin_entrada boolean DEFAULT false,
  frenos_entrada boolean DEFAULT false,
  estado_cauchos_entrada text,
  corneta_entrada boolean DEFAULT false,
  user_id uuid,

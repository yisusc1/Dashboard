            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-12">
                ...
                <div className="flex justify-between items-end mb-8">
                    ...
                    <div className="flex gap-2">
                        <div className="bg-white p-1 rounded-lg border border-zinc-200 flex gap-1 mr-4">
                            <Button
                        ...
                        <Button
                            ...
                            className="bg-zinc-900 text-white hover:bg-zinc-800 gap-2 shadow-lg shadow-zinc-200"
                        >
                            <Wrench size={18} />

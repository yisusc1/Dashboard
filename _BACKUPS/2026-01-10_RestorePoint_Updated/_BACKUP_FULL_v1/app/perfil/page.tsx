...
import { User, Shield, Mail, ArrowLeft, Building2, Briefcase, IdCard } from "lucide-react"
          ...
          <CardContent className="p-8 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-zinc-900 font-medium pl-6">{getDisplayValue(profile?.national_id)}</p>
              </div>

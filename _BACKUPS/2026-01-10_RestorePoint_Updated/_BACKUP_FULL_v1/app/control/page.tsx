            ...
            <div className="max-w-6xl mx-auto mb-12">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:flex items-center gap-3 w-full md:w-auto">
                        ...
                        <Link href="/control/combustible" className="w-full md:w-auto sm:col-span-2 md:col-span-1">
                            <Button className="w-full md:w-auto bg-orange-600 hover:bg-orange-700 text-white shadow-lg shadow-orange-500/20 font-bold rounded-xl h-12 px-6">
